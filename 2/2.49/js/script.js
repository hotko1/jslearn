...
// touchleave - коли палець, під час руху, вийшов за межі на елемент з подією
// touchcancel - коли точка дотику більше не реєструється на поверхні (наприклад палець вийшов за межі браузера)
